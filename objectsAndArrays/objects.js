...
/*
    ...
    - JSON exits as a string - useful when you want to fetch data from a server.
...
// console.log(baking);
// We have the ability to get NEW key/value pairs using square brackets.
